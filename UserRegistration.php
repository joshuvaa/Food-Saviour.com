          ...
          <div class="login-box">
            <div class="container" style="    width: 80%;">
              <div class="login-form py-5 px-4 mx-auto">
                <h3 class="account-title mb-4">User  <a href="">Sign Up</a></h3>
                ...
                <form action="#" method="GET">
                  ...
                  <div class="form-group">
                    <label class="field-info" for="Name">Address</label>
                  ...
                  <div class="form-group">
                    ...
                    <input type="tel" name="phone" class="form-control" maxlength="10"  placeholder="Phone" required pattern="[0-9]{10}" title="enter 10 digits only">                   </div>
                  <div class="form-group">
                ...
                if (isset($_REQUEST['submit'])) {
                  ...
                  $password = $_REQUEST['password'];
                    ...
                    $qryCheck = "SELECT COUNT(*) AS cnt FROM user_registration WHERE email = '$email' OR phone = '$password'";
                  ...
                  $qryReg = "INSERT INTO user_registration(name,address,phone,email,password) values('$name','$address','$phone','$email','$password')";
                  $qryLog = "INSERT INTO login (uid,username,password,type,`status`)values((select max(uid)from user_registration),'$email','$password','user','1')";
                  // echo $qryReg."\n".$qryLog;
