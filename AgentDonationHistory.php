  ...
  <div class="content py-5">
    <div class="container1">
      ...
      <div class="col-md-3 content-left pt-md-0 pt-3" style="margin-top:120px;">
          ...
          <p style=" margin: auto; color: #cc00ff;font-family:serif;text-align: center;padding-left: 5px;">Listing food Donation History from registerd Users with details . list of history with details about  the  users and adate of donations who contribute  donations  for you orphants pr
          </p>
        </div>
        <div class="col-md-9 content-photo mt-md-0 mt-9">
          ...
          <section class="w3l-about6 py-5">
            <div class="container py-md-3 text-center">
              <div class="">
                <h1 style="font-family: initial;color: white;text-shadow: 1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue;">Donation History</h1> <br><br>
                <center>
                  <!-- ..............start  -->

                  <?php
                  $qry = "SELECT * FROM `donations` d,`orphanage`o,`agent_registration` a WHERE d.`oid`=o.`oid` AND d.`aid`=a.`aid` AND d.`donate_status`='donated' AND a.`aid`='" . $uid . "'";
