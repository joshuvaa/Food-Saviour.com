              ...
              <div class="login-form py-5 px-4 mx-auto">
                ...
                <form action="#" method="GET">
                  <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="Name" required pattern="[A-Za-z-]+" title="enter characters only">
                  </div>
                  <div class="form-group">
                ...
                if (isset($_REQUEST['submit'])) {
                  ...
                  if ($conn->query($qryReg) == TRUE && $conn->query($qryLog) == TRUE) {
                    ...
                    echo "<script>alert('Registration Completed Successfully');window.location='Login.php'</script>";
                  } else {
                    echo "<script>alert('Registration failed');window.location='Login.php'</script>";
                  }
                }
                ?>
