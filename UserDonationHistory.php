    ...
    <div class="container1">
      <div class="row ">
        <div class="col-md-3 content-left pt-md-0 pt-3" style="margin-top:120px;">
          ...
          <p style=" margin: auto; color: #cc00ff;font-family:serif;text-align: center;padding-left: 5px;">Listing your donation list contains the detals about no of orphants ,locality address details , This procceesd list also contails the details about agents and date of donation ,
            ...
            <div class="container py-md-3 text-center">
              <div class="">
                ...
                <center>
                  ...
                  <?php
                  $qry = "SELECT * FROM `donations` d,`orphanage`o,`agent_registration` a WHERE d.`oid`=o.`oid` AND d.`aid`=a.`aid` AND d.`donate_status`='donated' AND d.`uid`='" . $uid . "'";
